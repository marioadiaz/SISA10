...
$("#buscador_clientes").keyup(function (event) {
  ...
  var id_orden_fumigacion = $(this).data("orden_fumigacion");
    ...
    $.get(request_url, function (data, status) {
      if (data.length > 0) {
        ...
        for (x in data) {
          ...
          var rowContent = "\n               <tr>\n                 <td>".concat(apellido, "</td>\n                 <td>\n                     <button \n                       class = \"btn btn-primary\"\n                       onclick=\"seleccionarCliente(").concat(id_cliente, ", ").concat(id_orden_fumigacion, ")\"\n                       >\n                         Agregar\n                     </button>\n                 </td>\n               </tr>\n            ");
...
/******/ });
//# sourceMappingURL=application-006e01243820fe57e6d2.js.map